...
class TestAgent:
    def __init__(self):
        self.now_phase = {}
        self.green_sec = 40  # pre-define time of green light
        self.max_phase = 8  # marz note: phase 1-8 allowed only
    ...
    def act(self, obs):
        ...
        for agent in self.agent_list:
            ...
            for k, v in observations_for_agent[agent].items():
                # marz note: current second
                now_step = v[0]
                break
            step_diff = now_step - self.last_change_step[agent]

            # marz note: every change of phase will have a 5sec 'all red'
